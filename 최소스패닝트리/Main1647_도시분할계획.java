...
public class Main1647_도시분할계획 {
	 ...
	 * (최소로 정렬한 뒤 연결하기 때문에 N-2의 간선만 선택하면 두개의 그룹으로 분할)
	 */
	static int[] parent;
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < M; i++) {
			...
			pq.add(new House(Integer.parseInt(st.nextToken()),Integer.parseInt(st.nextToken()),Integer.parseInt(st.nextToken())));
		}
